    ...
    <section id="about" className="py-20 section">
      <div className="container mx-auto px-4">
        <div className="mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-4">About <span className="text-[#00CCFF]">Me</span></h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="rounded-xl overflow-hidden relative group">
              <div className="absolute inset-0 bg-gradient-to-t from-[#0A2647]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                <div className="p-6">
                  <p className="text-[#E0E0E0] font-medium">Passionate about creating smooth, intuitive mobile experiences</p>
                </div>
              </div>
              <img 
          ...
          >
            <h3 className="text-2xl font-bold font-poppins mb-4">Mobile App Developer & UI/UX Enthusiast</h3>
            <p className="text-[#B0B0B0] mb-6">
              I'm a passionate mobile app developer with over 5 years of experience specializing in Flutter and Dart. 
              I create elegant, high-performance applications that deliver exceptional user experiences across both iOS and Android platforms.
            </p>
            <p className="text-[#B0B0B0] mb-8">
              My approach combines technical expertise with a deep understanding of design principles. 
              I believe great apps should be both beautiful and functional, with attention to detail that makes 
