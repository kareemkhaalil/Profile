...
export default function HeroSection() {
  ...
  useEffect(() => {
    const typeEffect = () => {
      ...
      if (
        !isDeleting.current &&
        currentCharIndex.current === currentPhrase.length
      ) {
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-poppins mb-6 text-[#E0E0E0]">
              Kareem Khalil
            </h1>
            ...
            <p className="text-[#B0B0B0] text-lg mb-8 max-w-lg">
              ...
              Transforming ideas into beautiful, functional apps that users
              love.
            </p>
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                className="rounded-full w-120 h-120 object-cover border-4 border-[#00CCFF] animate-float"
              />
            </div>
          </motion.div>
        </div>
