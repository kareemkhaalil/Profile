    ...
    <section id="contact" className="py-20 bg-[#1E1E1E] section">
      <div className="container mx-auto px-4">
        <div className="mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-4">Get In <span className="text-[#00CCFF]">Touch</span></h2>
          <div className="w-20 h-1 bg-[#00CCFF] mx-auto rounded-full mb-6"></div>
          <p className="text-[#B0B0B0] max-w-2xl mx-auto">Have a project in mind? Let's discuss how we can work together to bring your mobile app idea to life.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-[#B0B0B0]">San Francisco, California, USA</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-[#B0B0B0]">john@example.com</p>
                </div>
              </div>
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-[#2D2D2D] flex items-center justify-center text-[#B0B0B0] hover:bg-[#00CCFF] hover:text-[#121212] transition-colors">
          ...
          >
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                {isSubmitting ? (
                  <>Processing <i className="ri-loader-4-line ml-2 animate-spin"></i></>
                ) : (
